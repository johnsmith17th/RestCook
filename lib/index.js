...
RestCook.prototype.__buildAction = function(resource) {
	...
	if (action.index) {
		this.__buildIndex(action.index);
	}
	if (action.post) {
		this.__buildPost(action.post);
	}
	if (action.get) {
		this.__buildGet(action.get);
	}
	if (action.put) {
		this.__buildPut(action.put);
	}
	if (action.del) {
		this.__buildDel(action.del);
	}
};
 ...
 * @private
 */
RestCook.prototype.__buildIndex = function(action) {
	// body...
};
